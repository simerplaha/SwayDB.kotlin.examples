...
class Set<K>(private val database: swaydb.Set<K, IO<*>>) : swaydb.kotlin.Set<K>, Closeable {
    ...
    class Builder<K> {
        ...
        private var acceleration: Function1<LevelZeroMeter, Accelerator> = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$18`<K, scala.runtime.`Nothing$`>()
    ...
    companion object {
        ...
        fun <K> create(keySerializer: Any, dir: Path): Set<K> {
            val maxOpenSegments = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$2`<K, scala.runtime.`Nothing$`>()
            val cacheSize = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$3`<K, scala.runtime.`Nothing$`>()
            val mapSize = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$4`<K, scala.runtime.`Nothing$`>()
            val mmapMaps = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$5`<K, scala.runtime.`Nothing$`>()
            val recoveryMode = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$6`<K, scala.runtime.`Nothing$`>()
            val mmapAppendix = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$7`<K, scala.runtime.`Nothing$`>()
            val mmapSegments = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$8`<K, scala.runtime.`Nothing$`>()
            val segmentSize = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$9`<K, scala.runtime.`Nothing$`>()
            val appendixFlushCheckpointSize = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$10`<K, scala.runtime.`Nothing$`>()
            val otherDirs = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$11`<K, scala.runtime.`Nothing$`>()
            val cacheCheckDelay = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$12`<K, scala.runtime.`Nothing$`>()
            val segmentsOpenCheckDelay = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$13`<K, scala.runtime.`Nothing$`>()
            val bloomFilterFalsePositiveRate = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$14`<K, scala.runtime.`Nothing$`>()
            val compressDuplicateValues = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$15`<K, scala.runtime.`Nothing$`>()
            val deleteSegmentsEventually = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$16`<K, scala.runtime.`Nothing$`>()
            val lastLevelGroupingStrategy = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$17`<K, scala.runtime.`Nothing$`>()
            val acceleration = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$18`<K, scala.runtime.`Nothing$`>()
            val keyOrder = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$21`<K, scala.runtime.`Nothing$`>(dir,
                    maxOpenSegments, cacheSize, mapSize, mmapMaps, recoveryMode,
                    mmapAppendix, mmapSegments, segmentSize, appendixFlushCheckpointSize, otherDirs,
                    cacheCheckDelay, segmentsOpenCheckDelay,
