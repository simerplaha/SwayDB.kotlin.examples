...
class Map<K, V>(private val database: swaydb.Map<K, V, IO<*>>) : swaydb.kotlin.Map<K, V>, Closeable {
    ...
    companion object {
        ...
        fun <K, V> create(keySerializer: Any,
            ...
            val maxOpenSegments = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$2`<Any, Any>()
            val cacheSize = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$3`<Any, Any>()
            val mapSize = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$4`<Any, Any>()
            val mmapMaps = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$5`<Any, Any>()
            val recoveryMode = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$6`<Any, Any>()
            val mmapAppendix = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$7`<Any, Any>()
            val mmapSegments = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$8`<Any, Any>()
            val segmentSize = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$9`<Any, Any>()
            val appendixFlushCheckpointSize = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$10`<Any, Any>()
            val otherDirs = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$11`<Any, Any>()
            val cacheCheckDelay = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$12`<Any, Any>()
            val segmentsOpenCheckDelay = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$13`<Any, Any>()
            val bloomFilterFalsePositiveRate = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$14`<Any, Any>()
            val compressDuplicateValues = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$15`<Any, Any>()
            val deleteSegmentsEventually = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$16`<Any, Any>()
            val lastLevelGroupingStrategy = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$17`<Any, Any>()
            val acceleration = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$18`<Any, Any>()
            val keyOrder = swaydb.persistent.`Map$`.`MODULE$`.`apply$default$21`<Any, Any>(
